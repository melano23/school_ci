...
<head>
    <title>Informing Education Category Bootstrap Responsive Template | Home </title>
    <!-- Meta tag Keywords -->
...
<body>
    ...
    <div class="main-content" id="home">
        <div class="layer">
            ...
            <header>
                <div class="container-fluid px-lg-5">
                    ...
                    <div class="middle-right mt-sm-3 col-sm-6 text-right">
                        <h6><span class="fa fa-phone"></span> Enquiry : 0123123123</h6>
                    </div>
                </div>
                    <!-- nav -->
            ...
            <div class="container">
                <!-- /banner -->
                <div class="banner-info-camp-3layouts text-center">
                    <h3>Start Learning For Bright Future</h3>
                    <div class="read-more">
    ...
    <!--// mian-content -->
<!-- about-->
<section class="campree-row py-5" id="about">
		...
		<div class="row about-main">
			...
			<div class="col-lg-6 about-text-grid text-left">
				<div class="title-desc">
					<h3 class="main-title-camp-3pvt text-capitalize"> Laoreet erat nisi, sit ame</h3>
				</div>
				<p class="my-sm-4 mt-2 mb-4">Vestibulum feugiat tortor vitae diam euismod, ut et inter dum nisi fermentum. Pellentesque sed sodales nunc.
				Vestibulum laoreet erat nisi, sit amet ultrices., ut et inter dum nisi fermentum. Pellentesque sed sodales nunc. Vestibulum laoreet erat nisi, sit amet ultrices.ut et inter dum nisi fermentum. Pellentesque sed sodales nunc ut et inter dum nisi fermentum. Pellentesque sed sodales nunc ut et inter dum nisi fermentum. Pellentesque sed sodales nunc</p>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
				<div class="row inner-info">
					...
					<div class="col-10">
						<h4 class="mt-md-0 my-2">Perspiciatis unde</h4>
			...
			<div class="col-lg-4 col-md-6">
				<div class="row inner-info">
					...
					<div class="col-10">
						<h4 class="mt-md-0 my-2">Dolor volup</h4>
						<p class="">Sed ut perspiciatis unde omnis natus error dolor volup tatem ed accusan tium aliquet at leo dolor.</p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
				<div class="row inner-info">
					...
					<div class="col-10">
						<h4 class="mt-md-0 my-2">Error dolor</h4>
						<p class="">Sed ut perspiciatis unde omnis natus error dolor volup tatem ed accusan tium aliquet at leo dolor.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="row inner-info">
					...
					<div class="col-10">
						<h4 class="mt-md-0 my-2">Natus error</h4>
						<p class="">Sed ut perspiciatis unde omnis natus error dolor volup tatem ed accusan tium aliquet at leo dolor.</p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
				<div class="row inner-info">
					...
					<div class="col-10">
						<h4 class="mt-md-0 my-2">Unde omnis</h4>
						<p class="">Sed ut perspiciatis unde omnis natus error dolor volup tatem ed accusan tium aliquet at leo dolor.</p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6">
				<div class="row inner-info">
					...
					<div class="col-10">
						<h4 class="mt-md-0 my-2">Volup tatem</h4>
						<p class="">Sed ut perspiciatis unde omnis natus error dolor volup tatem ed accusan tium aliquet at leo dolor.</p>
					</div>
				</div>
			</div>
        ...
        <div class="container py-lg-5 py-md-3">
            <div class="row stat-grids">
                <div class="col-lg-6 stats-left">
                    ...
                    <p class="mb-3">Integer pulvinar leo id viverra feugiat. Pellentesque libero justo, semper at tempus vel, ultrices in ligula. Nulla sollicit sed.error dolor volup tatem ed accusan tium aliquet at leo dolor.</p>
                     </div>
                <div class="col-lg-6 grid1 stats-right mt-lg-0 mt-4 pl-5">
                    <div class="row">
                        <div class="col-sm-4 col-6">
                            <p class="text-li">Branches</p>
                            <h4 class="text-wh">110</h4>
...
<section class="testi py-5" id="testimonials">
	<div class="container pb-xl-5 py-lg-3">
		<h3 class="tittle two text-center heading mb-5">What our People say</h3>
		<div class="row">
			<div class="col-lg-6">
				<div class="row testi-cgrid border-right-grid">
					...
					<div class="col-sm-8">
						...
						<h6 class="b-camp-3ltxt mt-3">Smith - <span>Ipsum</span></h6>
					</div>
				</div>
			</div>
			<div class="col-lg-6 mt-lg-0 mt-sm-5 mt-4">
				<div class="row testi-cgrid border-left-grid">
					...
					<div class="col-sm-8">
						<p class="mx-auto"><span class="fa fa-quote-left"></span> Onec consequat sapien utleo dolor rhoncus. Nullam dui mi, vulputater act metus semper. Vestibulum sed dolor.</p>
						<h6 class="b-camp-3ltxt mt-3">Warner - <span>Lorem</span></h6>
					</div>
				</div>
			</div>
		</div>
...
<section class="team py-5" id="team">
	<div class="container py-xl-5 py-lg-3">
		...
		<div class="row inner-sec-camp-3layouts-camp-3pvt-lauinfo">
		...
		<div class="row about-main">
			<div class="col-lg-6 about-text-grid1 text-left">
				<div class="title-desc">
					...
					<h3 class="main-title-camp-3pvt text-capitalize my-4"> Join With Us. We will make the best Education together!</h3>
				</div>
				
			</div>
			<div class="col-lg-6 about-right mt-lg-0 mt-4">
				<p class="">Vestibulum feugiat tortor vitae diam euismod, ut et inter dum nisi fermentum. Pellentesque sed sodales nunc.
				Vestibulum laoreet erat nisi, sit amet ultrices. Vestibulum feugiat tortor vitae diam euismod, ut et inter dum nisi fermentum. Pellentesque sed sodales nunc.
				Vestibulum laoreet erat nisi, sit amet ultrices vitae diam.</p>
				<p class="mt-4">Vestibulum feugiat tortor vitae diam euismod, ut et inter dum nisi fermentum. Pellentesque sed sodales nunc.
				Vestibulum laoreet erat nisi, sit amet ultrices inter dum nisi vitae diam fermentum.</p>
			</div>
		</div>
	</div>
</section>
...
<section class="contact py-5" id="contact">
	<div class="container py-sm-4">
		...
		<div class="row contact-top">
			<div class="col-lg col-md-6 contact-grid-campree">
			...
			<div class="col-lg-6 col-md-6 contact-grid-campree foot-top mt-md-0 mt-5">
				...
				<div class="contact-info">
					...
					<div class="contact-style-camp-3ls">
						<p><span class="fa fa-map-marker"></span><strong>Location :</strong> 1127 Block, 4th floor, London.</p>
					</div>
					<div class="contact-style-camp-3ls my-2">
						<p><span class="fa fa-envelope-open"></span><strong>Email :</strong> <a href="mailto:example@mail.com">example@mail.com</a></p>
					</div>
					<div class="contact-style-camp-3ls">
    ...
    <footer class="footer-content">
        <div class="layer footer-1">
            <div class="container-fluid">
                <div class="row footer-top-inner-camp-3ls">
                    ...
                    <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
                        <div class="footer-camp-3pvt">
                            <h3 class="mb-3 camp-3pvt_title">Office Hours</h3>
                            <hr>
                            <ul class="list-info-camp-3pvt last-camp-3ls-contact mt-lg-4">
                                <li>
                    ...
                    <div class="col-lg-3 col-md-6 mt-lg-0 mt-5">
                        <div class="footer-camp-3pvt">
                            <h3 class="mb-3 camp-3pvt_title">Newsletter</h3>
                            <hr>
                ...
                <p class="copy-right-grids text-li text-center my-sm-4 my-4">© 2019 Informing. All Rights Reserved.
                </p>
                <div class="camp-3ls-footer text-center mt-4">
                    <ul class="list-unstyled camp-3ls-icons">
                        <li>
                            <a href="#">
